...
<center>
<div>
<h1>Folgende Angebote für Nachhilfestunden sind Online</h1>
...
$dblk=db();
       ...
       {if($_POST['order2']=="abfallend")
        {$sqlbefehl1="SELECT * FROM nachhilfestunden WHERE ".$_POST['option']." LIKE'%". $_POST['textfeld']."%' AND suche='off' ORDER BY ".$_POST['order']." DESC";}
        else
        {$sqlbefehl1="SELECT * FROM nachhilfestunden WHERE ".$_POST['option']." LIKE'%". $_POST['textfeld']."%' AND suche='off' ORDER BY ".$_POST['order']."";}
       }
       else
       {
        if($_POST['order2']=="abfallend")
       {$sqlbefehl1="SELECT * FROM nachhilfestunden WHERE suche='off' ORDER BY ".$_POST['order']." DESC";}
       else
       {$sqlbefehl1="SELECT * FROM nachhilfestunden WHERE suche='off' ORDER BY ".$_POST['order']."";}
       }
